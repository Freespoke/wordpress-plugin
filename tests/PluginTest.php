...
class PluginTest extends TestCase
{
    ...
    public function testInitRegistersWarningWhenNoCredentials(): void
    {
        ...
        // One registration for the missing-credentials notice, plus the
        // always-on test-mode notice registered later in init().
        Actions\expectAdded('admin_notices')->twice();
        Actions\expectAdded('wp_trash_post')->never();
        Actions\expectAdded('before_delete_post')->never();
    ...
    public function testRegistersTrashAndDeleteHooks(): void
    {
        Functions\expect('get_option')->andReturn('');
        Functions\expect('register_activation_hook')->once();
        Functions\expect('register_deactivation_hook')->once();
        ...
        Actions\expectAdded('before_delete_post')->once();
