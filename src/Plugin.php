...
class Plugin
{
    ...
    public static function init(array $config): void
    {
        ...
        if ($settings->hasCredentials()) {
            ...
            add_action('wp_trash_post', [$publisher, 'onTrashOrDelete'], 10, 1);
            add_action('before_delete_post', [$publisher, 'onTrashOrDelete'], 10, 1);
        } else {
        ...
        add_action('admin_notices', [$admin, 'renderTestModeNotice']);
        // Editor notices
