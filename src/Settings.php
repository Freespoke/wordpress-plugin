...
class Settings
{
    ...
    {
        if (isset($this->overrides['test_mode'])) {
            return filter_var($this->overrides['test_mode'], \FILTER_VALIDATE_BOOLEAN);
        }
        return filter_var(get_option('freespoke_test_mode', \false), \FILTER_VALIDATE_BOOLEAN);
    }
    public function isTestModeLocked(): bool
    {
        return isset($this->overrides['test_mode']);
    }
    public function save(array $input): void
    {
        ...
        if (!$this->isTestModeLocked()) {
            update_option('freespoke_test_mode', !empty($input['test_mode']));
        }
    }
    /**
