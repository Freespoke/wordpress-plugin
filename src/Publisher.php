...
class Publisher
{
     ...
     * or permanent (retried only when the post is modified or the partner
     * epoch advances past the failure time).
     *
     ...
     * request won't change the outcome until the post or the server changes,
     * and an epoch advance is the server-changed signal.
     *
