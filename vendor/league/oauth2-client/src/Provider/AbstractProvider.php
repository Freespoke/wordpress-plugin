 ...
 */
namespace FreespokeDeps\League\OAuth2\Client\Provider;

use FreespokeDeps\GuzzleHttp\Client as HttpClient;
use FreespokeDeps\GuzzleHttp\ClientInterface as HttpClientInterface;
use FreespokeDeps\GuzzleHttp\Exception\BadResponseException;
use FreespokeDeps\GuzzleHttp\Exception\GuzzleException;
use InvalidArgumentException;
use FreespokeDeps\League\OAuth2\Client\Grant\AbstractGrant;
use FreespokeDeps\League\OAuth2\Client\Grant\GrantFactory;
use FreespokeDeps\League\OAuth2\Client\OptionProvider\OptionProviderInterface;
use FreespokeDeps\League\OAuth2\Client\OptionProvider\PostAuthOptionProvider;
use FreespokeDeps\League\OAuth2\Client\Provider\Exception\IdentityProviderException;
use FreespokeDeps\League\OAuth2\Client\Token\AccessToken;
use FreespokeDeps\League\OAuth2\Client\Token\AccessTokenInterface;
use FreespokeDeps\League\OAuth2\Client\Tool\ArrayAccessorTrait;
use FreespokeDeps\League\OAuth2\Client\Tool\GuardedPropertyTrait;
use FreespokeDeps\League\OAuth2\Client\Tool\QueryBuilderTrait;
use FreespokeDeps\League\OAuth2\Client\Tool\RequestFactory;
use FreespokeDeps\Psr\Http\Message\RequestInterface;
use FreespokeDeps\Psr\Http\Message\ResponseInterface;
