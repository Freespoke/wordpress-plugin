 ...
 */
namespace FreespokeDeps\League\OAuth2\Client\Grant;

use FreespokeDeps\League\OAuth2\Client\Grant\Exception\InvalidGrantException;
/**
...
class GrantFactory
{
    ...
    protected function registerDefaultGrant($name)
    {
        ...
        $class = 'FreespokeDeps\League\OAuth2\Client\Grant\\' . $class;
