...
use FreespokeDeps\GuzzleHttp\Cookie\CookieJar;
use FreespokeDeps\GuzzleHttp\Exception\GuzzleException;
use FreespokeDeps\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \FreespokeDeps\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
